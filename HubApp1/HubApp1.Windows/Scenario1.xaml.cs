...
namespace simpleInk
{
    ...
    public sealed partial class Scenario1 : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        {
            //InkingArea.Height = (sender as BitmapImage)
        }

        private void Im1Iopen(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            //var werewff = (sender as Image);
            Image img = sender as Image;
            var ewre = img.Source as BitmapImage;

            //InkingArea.Height = ewre.PixelHeight;
            //InkingArea.Width = ewre.PixelWidth;
            InkingArea.Height = img.ActualHeight;
            InkingArea.Width = img.ActualWidth;

        }

        private void bkcli(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            WebViewRightTop.GoBack();
        }

        private void fwcli(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            WebViewRightTop.GoForward();
        }

        private void wfwee(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            WebViewRightTop.Source = new Uri(textBox.Text);
        }
    }
}
