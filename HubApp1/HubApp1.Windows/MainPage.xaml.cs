...
namespace SDKTemplate
{
    ...
    public sealed partial class MainPage : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        /// </summary>
        /// <param name="scenarioName"></param> //todo bug i dont do laundry i write software i dont cook dinner i write software i dont want ti - cook software i dont watch tv i write software 1 line not 2 2 next possible 2();
        ...
        private void OutputSection_Loaded(object sender, RoutedEventArgs e)
        {
            Grid_OutputSection = sender as Grid;

            var rewre = new simpleInk.Scenario1();
            Grid_OutputSection.Children.Add(rewre);
        }
        public Grid Grid_OutputSection = new Grid();
    }
